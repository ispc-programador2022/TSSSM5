...
website = 'https://datosmacro.expansion.com/demografia/migracion/inmigracion?anio=2010'
...
inmig = rqst.get ('https://datosmacro.expansion.com/demografia/migracion/inmigracion?anio=2010')
...
finalInmig2010 = pd.DataFrame(InmigBody, columns=rowHeadersInmig)
print (finalInmig2010)
